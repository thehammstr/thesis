...
\subsubsection*{Chapter \ref{ch.ProblemStatement}: Problem Statement}  This chapter recasts the optimization used by Kimball \cite{} in the moving reference frame of the iceberg. This reduces greatly the number of estimation parameters, and eliminates the need for the vehicle to have knowledge of its inertial position.

...
The loop closure step gives a number of constraints on the vehicle's trajectory. The next step is to then determine how the initial estimate of trajectory should be altered in such a way that these constraints are satisfied, minimizinig measurement inconsistencies. 
